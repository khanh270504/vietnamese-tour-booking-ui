...
export function HomePage() {
  ...
  {
    id: "5",
    image: "https://images.unsplash.com/photo-1643030080539-b411caf44c37?q=80&w=1080",
  ...
  {
    id: "6",
    image: "https://images.unsplash.com/photo-1562004966-39bfac0faf6b?q=80&w=1080",
  ...
  {
    name: "Hà Nội",
    image: "https://images.unsplash.com/photo-1677837564800-73a0bb0ef938?q=80&w=1080",
    tours: "32 tour"
  },
  {
    name: "Sapa",
  ...
  {
    name: "Nha Trang",
    image: "https://images.unsplash.com/photo-1643030292895-caeed7e5d4f1?q=80&w=1080",
    tours: "22 tour"
  }
];
  return (
    <div className="w-full">
          ...
          <div className="container mx-auto px-4 h-full flex flex-col items-center justify-center text-center">
            ...
            <div className="bg-white rounded-lg shadow-2xl p-6 max-w-4xl w-full">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <Link to="/tours">
                  <button className="w-full bg-[#2563eb] hover:bg-[#1d4ed8] h-10 text-white rounded-lg flex items-center justify-center">
      ...
      <section className="container mx-auto px-4 py-16">
        <div className="flex items-center justify-between mb-8">
          ...
          <Link to="/tours">
            <button className="border-[#2563eb] text-[#2563eb] hover:bg-[#2563eb] hover:text-white border py-2 px-4 rounded-lg">
              Xem tất cả
            ...
            <div className="absolute inset-0 bg-black/50 flex items-center justify-center">
              <div className="text-center text-white">
                <h2 className="text-3xl font-bold mb-4">
                  Bạn đã sẵn sàng cho chuyến phiêu lưu tiếp theo chưa?
                </h2>
